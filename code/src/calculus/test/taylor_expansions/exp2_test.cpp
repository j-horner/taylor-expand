...
TEST_F(Exp2Test, Exponential_2_Is_Correct) {
    ...
    // constexpr auto ln2 = 0.69314718055994530941723212145818_c;
    constexpr auto ln2 = 0.693_c;

    constexpr auto H = [ln2] (auto y) { return ln2*y; };
...

    {
		...
		// N = 6, or ln2 = 0.6931 --> integer overflow!
        constexpr auto y = taylor_expand<5>(H, y_0);
